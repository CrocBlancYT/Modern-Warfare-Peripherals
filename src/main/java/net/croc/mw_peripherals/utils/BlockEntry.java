...
public class BlockEntry<T extends Block> {
    ...
    public static <T extends Block> BlockEntry<T> create(String id) {
        return new BlockEntry<>(id);
    }

    public BlockEntry<T> blockSupplier(Supplier<T> blockSupplier) {
        this.blockSupplier = blockSupplier;
        return this;
    }

    public BlockEntry<T> itemSupplier(Supplier<Item> itemSupplier) {
    ...
    public BlockEntry<T> saveTo(ArrayList<BlockEntry<?>> entries) {
        entries.add(this);
        return this;
    }
